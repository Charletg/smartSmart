        ...
        getContext.then(function (response) {
                ...
                function differentServices(element) {
                    for (var service in element) {
                        myIdEntity = element[service].id;
                        myEntity = element[service].name;
                        myImgPath = element[service].iconURL;
                    }
                }

                myServices = new Array(json.bricks);
                myServices.forEach(differentServices);
                if (myIdEntity) {
                    window.document.getElementById("myJson").textContent = myEntity;
                    var myImg = document.createElement("img");
                    myImg.src = myImgPath;
                    window.document.getElementById("myImg").appendChild(myImg);
