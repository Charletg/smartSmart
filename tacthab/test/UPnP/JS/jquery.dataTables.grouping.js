    ...
    $.fn.rowGrouping = function (options) {
        ...
        return this.each(function (index, elem) {
                ...
                function _fnOnGroupClick(e) {
                    ...
                    ///Brubru -> modif pour laisser tranquille le glyphicon si on ne clique pas dessus et faire une action si on clique dessus
                    var truc = $(e.target);
                    if (truc.is('td')) {
                        ///<summary>
                        ...
                        if (truc.is('a') || truc.is('i')) {
                            var estPause = $(this).children().children().hasClass('glyphicon-pause')
                            var that = $(this).children().children();
                            var enCours = $('.glyphicon-pause').not($(this).children());
                            estPause = $(this).children().children().hasClass('glyphicon-pause')
                            enCours = $('.glyphicon-pause').not($(this).children());
                            that = $(this).children().children();
                            console.log(estPause + ', ' + enCours + ', ' + that);
